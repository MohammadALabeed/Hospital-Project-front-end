...
// عرض شاشة "جارٍ التحميل" أثناء فحص السيرفر للتأكد من وجود جلسة قديمة أم لا
  if (checkingSession) {
    return (
      <div
        ...
        <span className="text-secondary text-xs font-bold uppercase tracking-widest font-sans">
          {t("app.session.verifying", "Verifying secure user session...")}//دالة نص الترجمة او النص الافتراضي
        </span>
      </div>
    );
  }
  ...
  if (!session) {//إذا لم يكن هناك جلسة مستخدم نشطة، يتم عرض صفحة تسجيل الدخول
